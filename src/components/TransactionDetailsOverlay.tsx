    ...
    <div className="absolute inset-0 z-30 bg-white overflow-auto">
      <div className="flex flex-col h-full">
        ...
        <div className="p-4 flex-1 overflow-y-auto space-y-4 max-w-lg mx-auto">
          ...
          {bureauDecisionData && bureauDecisionData.finalDecision.toLowerCase() === 'rejected' && bureauDecisionData.rejectionReasons && bureauDecisionData.rejectionReasons.length > 0 && !transaction.disbursedAt && (
            <>
          ...
          {(!bureauDecisionData || bureauDecisionData.finalDecision.toLowerCase() !== 'rejected' || !bureauDecisionData.rejectionReasons?.length) && transaction.rejectionReasons && !transaction.disbursedAt && (
            <>
              <div className="bg-gray-600 text-white font-medium px-4 py-2 rounded-lg flex items-center space-x-2 border border-gray-200 shadow-sm">
                <AlertTriangle className="h-4 w-4" />
                <span>Rejected</span>
