  ...
  (error) => {
    if (error.response) {
      ...
      switch (error.response.status) {
        ...
        case 401:
          // Only clear authentication data for specific 401 errors that indicate token expiration
          // Check if the error response indicates token expiration specifically
